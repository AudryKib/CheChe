...
using AuctionService.Models.Enum;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;

namespace AuctionService.Data.DbInitializer
{
    public class DbInitializer
    {
        public static void InitDb(WebApplication app)
        {
            ...
            var context = serviceScope.ServiceProvider.GetService<AuctionDBContext>();
        ...
        private static void SeedData(AuctionDBContext context, ILogger logger)
        {
            try
            {
                context.Database.Migrate();
